	...
	public CreaProgetto(String matricola) {
		...
		btnCrea.addActionListener(e -> {
    		...
    		if(nome.isEmpty() || desc.isEmpty()) {
    			JOptionPane.showMessageDialog(this, "Compila tutti i campi","Dati invalidi",JOptionPane.ERROR_MESSAGE);
    			return;
    		}
    		...
    		try {
    			...
    			JOptionPane.showMessageDialog(this, ex.getMessage(),"Errore nella creazione del progetto",JOptionPane.ERROR_MESSAGE);
    		}catch(IllegalArgumentException ex) {
    			JOptionPane.showMessageDialog(this, ex.getMessage(),"Dati invalidi",JOptionPane.ERROR_MESSAGE);
    		}
    });
